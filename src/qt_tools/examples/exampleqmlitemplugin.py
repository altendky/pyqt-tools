...
import qt_tools.examples.exampleqmlitem
sys.stderr.write('exampleqmlitemplugin.py debug: : just imported qt_tools.examples.exampleqmlitem\n')
sys.stderr.flush()
    ...
    def registerTypes(self, uri):
        ...
        try:
            QtQml.qmlRegisterType(
                qt_tools.examples.exampleqmlitem.ExampleQmlItem,
                'examples',
                1,
                0,
                'ExampleQmlItem',
